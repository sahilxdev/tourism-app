  ...
  return (
    <div className="flex justify-center">
      <div className="w-[70vw] flex justify-evenly mt-5">
        ...
        <Link to={"/hotels"}>
          <div className="flex flex-col items-center  text-gray-400 hover:text-gray-700 text-center cursor-pointer rounded-xl justify-center px-2 hover:bg-slate-200">
            <div className="text-4xl text-center px-2 ">
              <HotelIcon />
            </div>
            <div className="text-sm font-medium text-gray-600">HOTELS</div>
          </div>
        </Link>
        <Link to={"/ships"}>
          <div className="flex flex-col items-center  text-gray-400 hover:text-gray-700 text-center cursor-pointer rounded-xl justify-center px-2 hover:bg-slate-200">
            ...
            <div className="text-sm font-medium text-gray-600">SHIP</div>
          </div>
        </Link>
        <Link to={"/bus"}>
          <div className="flex flex-col items-center  text-gray-400 hover:text-gray-700 text-center cursor-pointer rounded-xl justify-center px-2 hover:bg-slate-200">
            ...
            <div className="text-sm font-medium text-gray-600">BUS</div>
          </div>
        </Link>
        <Link to={"/cabs"}>
          <div className="flex flex-col items-center  text-gray-400 hover:text-gray-700 text-center cursor-pointer rounded-xl justify-center px-2 hover:bg-slate-200">
            ...
            <div className="text-sm font-medium text-gray-600">CABS</div>
          </div>
        </Link>
        <Link to={"/ferries"}>
          <div className="flex flex-col items-center  text-gray-400 hover:text-gray-700 text-center cursor-pointer rounded-xl justify-center px-2 hover:bg-slate-200">
        ...
        <Link to={"/dining"}>
          <div className="flex flex-col items-center  text-gray-400 hover:text-gray-700 text-center cursor-pointer rounded-xl justify-center px-2 hover:bg-slate-200">
            ...
            <div className="text-sm font-medium text-gray-600">DININGS</div>
          </div>
        </Link>
        <Link to={"/trekking"}>
          <div className="flex flex-col items-center  text-gray-400 hover:text-gray-700 text-center cursor-pointer rounded-xl justify-center px-2 hover:bg-slate-200">
            ...
            <div className="text-sm font-medium text-gray-600">TREKKING</div>
          </div>
        </Link>
        <Link to={"/shop"}>
          <div className="flex flex-col items-center  text-gray-400 hover:text-gray-700 text-center cursor-pointer rounded-xl justify-center px-2 hover:bg-slate-200">
