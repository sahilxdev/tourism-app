    ...
    <div>
        <div className=' bg-gradient-to-b from-blue-900 opacity-90 mt-2 to-transparent min-h-96'>
            ...
            <div className='flex justify-center gap-[275px] my-5'>
                <button className=' p-3 bg-[#FF8782] rounded-md text-white text-xl'>Government Bus Booking</button>
                <button className=' p-3 bg-[#FF8782] rounded-md text-white text-xl'>Private Bus Booking</button>
            </div>
            <div className='flex justify-center gap-8'>
                <div className='relative rounded-xl shadow-md flex flex-col justify-center'>
